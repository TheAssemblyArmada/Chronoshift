...
{
    if (!no_buttons) {
        ButtonPlus = new ShapeButtonClass(id, MixFileClass<CCFileClass>::Retrieve("BTN-PLUS.SHP"), XPos + Width + 2, YPos);
        ...
        ButtonMinus = new ShapeButtonClass(id, MixFileClass<CCFileClass>::Retrieve("BTN-MINS.SHP"), XPos - 6, YPos);
