...
enum ThreatType
{
    ...
    THREAT_1 = 0x1,
    THREAT_2 = 0x2,
    THREAT_ANY_AIRCRAFT = 0x4, // AIR / AIRCRAFT?
    THREAT_INFANTRY = 0x8,
    THREAT_ANY_VEHICLE = 0x10,
    THREAT_ANY_BUILDING = 0x20,
    THREAT_HARVESTERS = 0x40, // Economy?
    THREAT_ANY_VESSEL = 0x80,
    ...
    // combined
    THREAT_3D60 = (THREAT_ANY_BUILDING | THREAT_HARVESTERS | THREAT_Neutral | THREAT_Fakes | THREAT_POWER_FACILTIES
