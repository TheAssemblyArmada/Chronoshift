...
void SidebarClass::StripClass::One_Time(int column)
{
...
#else
    char icon_fname[16];
    // ClockShapes = GameFileClass::Retrieve_File("clock.shp");
    ...
    //    SpecialShapes[super] = GameFileClass::Retrieve_File(icon_fname);
    //}
#endif
}
...
void SidebarClass::StripClass::Init_IO(int column)
{
    if (!g_inMapEditor) {
        ...
        UpButton[WhichColumn].Set_Shape(GameFileClass::Retrieve_File("stripup.shp"));
        ...
        DownButton[WhichColumn].Set_Shape(GameFileClass::Retrieve_File("stripdn.shp"));
...
void SidebarClass::One_Time()
{
    ...
    if (SidebarShape == nullptr) {
        SidebarShape = GameFileClass::Retrieve_File("sidebar.shp");
    }

    if (SidebarAddonShape == nullptr) {
        SidebarAddonShape = GameFileClass::Retrieve_File("addon.shp");
    }
}
...
void SidebarClass::Init_IO()
{
    ...
    if (!g_inMapEditor) {
        ...
        RepairButton.Set_Shape(GameFileClass::Retrieve_File("repair.shp"));
...
// TODO Needs HouseClass
    ...
    SidebarShape = GameFileClass::Retrieve_File(sidebarnames[side_index]);
    sidebarnames[side_index][4] = '2';
    SidebarMiddleShape = GameFileClass::Retrieve_File(sidebarnames[side_index]);
    sidebarnames[side_index][4] = '3';
    SidebarBottomShape = GameFileClass::Retrieve_File(sidebarnames[side_index]);
