...
// If you want to add extra animations, you will also need to add a template
...
enum AnimType
{
    ...
    ANIM_FIREBALLFADE, // "FB2
    ANIM_FRAG1, // "FRAG1"
    ANIM_VEH_HIT1, // "VEH-HIT1"
    ANIM_VEH_HIT2, // "VEH-HIT2"
    ANIM_VEH_HIT3, // "VEH-HIT3"
    ANIM_ART_EXP1, // "ART-EXP1"
    ANIM_NAPALM1, // "NAPALM1"
    ANIM_NAPALM2, // "NAPALM2"
    ANIM_NAPALM3, // "NAPALM3"
    ANIM_SMOKE_PUFF, // "SMOKEY"
    ANIM_PIFF, // "PIFF"            //small arms fire piff (single shot)
    ANIM_PIFFPIFF, // "PIFFPIFF"        //small arms fire piff (multiple shots)
    ANIM_FIRE3, // "FIRE3"            //small flames
    ANIM_FIRE2, // "FIRE2"
    ANIM_FIRE1, // "FIRE1"
    ANIM_FIRE4, // "FIRE4"
    ...
    ANIM_GUN_W, // "MINIGUN"
    ANIM_GUN_NW, // "MINIGUN"
    ANIM_LZ_SMOKE, // "SMOKLAND"
    ANIM_CRATE_DEVIATOR, // "DEVIATOR"
    ANIM_CRATE_DOLLAR, // "DOLLAR"            //Money bonus
    ANIM_CRATE_EARTH, // "EARTH"
    ANIM_CRATE_EMPULSE, // "EMPULSE"
    ANIM_CRATE_INVUN, // "INVUN"
    ANIM_CRATE_MINE, // "MINE"
    ANIM_CRATE_RAPID, // "RAPID"
    ANIM_CRATE_STEALTH, // "STEALTH2"
    ANIM_CRATE_MISSILE, // "MISSILE2"
    ANIM_MOVEFLASH, // "MOVEFLSH"
    ANIM_OILFIELD_BURN, // "FLMSPT"
    ANIM_ELECTRO, // "ELECTRO"
    ANIM_PARACHUTE, // "PARACH"
    ANIM_ELECTDOG, // "ELECTDOG"
    ANIM_CORPSE1, // "CORPSE1"
    ANIM_CORPSE2, // "CORPSE2"
    ANIM_CORPSE3, // "CORPSE3"
    ANIM_SPUTDOOR, // "SPUTDOOR"
    ANIM_ATOMSFX, // "ATOMSFX"
    ANIM_CHRONOBOX, // "CHRONBOX"
    ANIM_GPSBOX, // "GPSBOX"
    ANIM_INVULBOX, // "INVULBOX"
    ANIM_PARABOX, // "PARABOX"
    ANIM_SONARBOX, // "SONARBOX"
    ANIM_TWINKLE1, // "TWINKLE1"            //ore twinkle animation
    ANIM_TWINKLE2, // "TWINKLE2"            //ore twinkle animation
    ANIM_TWINKLE3, // "TWINKLE3"            //ore twinkle animation
    ANIM_FLAK, // "FLAK"
    ANIM_WATER_EXP1, // "H2O_EXP1"
    ANIM_WATER_EXP2, // "H2O_EXP2"
    ANIM_WATER_EXP3, // "H2O_EXP3"
    ANIM_CRATE_ARMOR, // "ARMOR"            //Armor bonus
    ANIM_CRATE_SPEED, // "SPEED"
    ANIM_CRATE_FPOWER, // "FPOWER"            //Firepower bonus crate animation
    ANIM_CRATE_TQUAKE, // "TQUAKE"
    ANIM_PARABOMB, // "PARABOMB"
    ANIM_MINEEXP1, // "VEH-HIT2"
    ANIM_ANTDEATH, // "ANTDIE"
    ANIM_COUNT,
};
