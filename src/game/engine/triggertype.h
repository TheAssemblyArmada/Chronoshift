...
DEFINE_ENUMERATION_BITWISE_OPERATORS(TriggerType);
...
protected:
    ...
    //TEventClass EventOne;		//0x2B
    //TEventClass EventTwo;		//0x34
    ...
    //TActionClass ActionOne;	//0x3E
    //TActionClass ActionTwo;	//0x4B
